...
test('should update existing item in left Panel', () => {
  const state: PanelState = { ...createDefaultState(), uid: 1 }
  ...
  const stateWithItems: PanelState = {
    ...state,
...
test('should insert item at beginning when item does not exist', () => {
  const state: PanelState = { ...createDefaultState(), uid: 2 }
  const item1: StatusBarItem = {
    ariaLabel: 'Item 1',
...
test('should update item in middle of array', () => {
  const state: PanelState = { ...createDefaultState(), uid: 3 }
  const item1: StatusBarItem = {
    ariaLabel: 'Item 1',
    elements: [{ type: 'text', value: 'Item 1' }],
    name: 'item1',
...
test('should preserve right Panel items', () => {
  const state: PanelState = { ...createDefaultState(), uid: 4 }
...
test('should preserve uid', () => {
  const state: PanelState = { ...createDefaultState(), uid: 42 }
...
test('should handle empty left items array', () => {
  const state: PanelState = { ...createDefaultState(), uid: 5 }
  const newItem: StatusBarItem = {
    ariaLabel: 'New Item',
    elements: [{ type: 'text', value: 'New Item' }],
    name: 'newItem',
...
test('should update item with all optional properties', () => {
  const state: PanelState = { ...createDefaultState(), uid: 6 }
  const item: StatusBarItem = {
    ariaLabel: 'Item',
    elements: [{ type: 'text', value: 'Item' }],
    name: 'item',
